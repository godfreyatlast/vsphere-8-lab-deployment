...
$VCSAInstallerPath = "D:\Lab\Vendors\VMware\vsphere_7\VMware-VCSA-all-7.0.3-21477706"

# Nested ESXi VMs to deploy
$NestedESXiHostnameToIPs = @{
	"$nest_var-esxi1" = "10.0.90.71"
	"$nest_var-esxi2" = "10.0.90.72"
	"$nest_var-esxi3" = "10.0.90.73"
###	"$nest_var-esxi4" = "10.0.90.74"
###	"$nest_var-esxi5" = "10.0.90.75"
###	"$nest_var-esxi6" = "10.0.90.76"
}
...
$VCSAIPAddress = "10.0.90.70"
$VCSAHostname = "$nest_var-vcsa1" #Change to IP if you don't have valid DNS
$VCSAPrefix = "24"
