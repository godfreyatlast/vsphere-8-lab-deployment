###James variable
$nest_var = "n1"
### Run cli vcsa install D:\Lab\Vendors\VMware\vsphere_8\VMware-VCSA-all-8.0.0-21216066\vcsa-cli-installer\win32\vcsa-deploy.exe install --no-esx-ssl-verify --accept-eula --acknowledge-ceip D:\git_repos\github\vsphere-8-lab-deployment\n4-jsontemplate.json"
### check logs Get-Content -Path "C:\temp\n4-nested_lab-lab-deployment.log" -Wait
# Author: William Lam
# Website: www.williamlam.com

# vCenter Server used to deploy vSphere & vSAN 8 Lab
$VIServer = "vcsa1.lab.lan"
$VIUsername = "james.godfrey@lab.lan"
$VIPassword = "AQ!sw2de3"

# Full Path to the Nested ESXi 8.0 VA & Extracted VCSA 8.0 ISO
$NestedESXiApplianceOVA = "D:\Lab\Vendors\VMware\vsphere_7\Nested_ESXi7.0u3m_Appliance_Template_v1.ova"
$VCSAInstallerPath = "D:\Lab\Vendors\VMware\vsphere_7\VMware-VCSA-all-7.0.3-22357613"

# Nested ESXi VMs to deploy
$NestedESXiHostnameToIPs = @{
	"$nest_var-esxi1" = "10.0.90.11"
	"$nest_var-esxi2" = "10.0.90.12"
	"$nest_var-esxi3" = "10.0.90.13"
}
...
$VCSADisplayName = "$nest_var-vcsa1"
$VCSAIPAddress = "10.0.90.10"
$VCSAHostname = "$nest_var-vcsa1.lab.lan" #Change to IP if you don't have valid DNS
$VCSAPrefix = "24"
...
$VMDatastore = "vsanDatastore-core"
$VMNetmask = "255.255.255.0"
$VMGateway = "10.0.90.1"
$VMDNS = "10.0.10.100"
$VMNTP = "10.0.10.100"
$VMPassword = "AQ!sw2de3fr4"
$VMDomain = "lab.lan"
...
$NewVCDatacenterName = "nested-Datacenter"
$NewVCVSANClusterName = "nested-Cluster"
$NewVCVDSName = "nested-VDS"
$NewVCMgmtPortgroupName = "nested-DVPG-Management-Network"
...
$verboseLogFile = "C:\temp\$nest_var-nested_lab-lab-deployment.log"
